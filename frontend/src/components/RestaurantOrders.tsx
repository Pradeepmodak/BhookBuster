...
// socket instance from context for real-time updates
// new orders + updates to existing orders status
const { socket } = useSocket();

// stores the audio element for order notifications
...
// history of completed orders for the restaurant
